...
class Navbar extends React.Component {
	...
	render() {
		const originUrl = `http://${window.location.host.split(":")[0]}:3000`;			
		return (
				...
				<div id="navbar-main" className="container">
					...
					<div className="collapse navbar-collapse default-nav" id="navbarSupportedContent">
						<ul className="navbar-nav ml-auto" id="mymenu">
							...
							<li className="nav-item">
								<a className="nav-link" href={originUrl}>sign in</a>
							</li>
							<li className="nav-item">
								<a className="nav-link" href={`${originUrl}/register`}>sign up</a>
							</li>
